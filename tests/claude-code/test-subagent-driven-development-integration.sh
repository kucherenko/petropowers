...
mkdir -p src test docs/petropowers/plans

# Create a simple implementation plan
cat > docs/petropowers/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/petropowers/plans/implementation-plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from petropowers directory so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/petropowers/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"petropowers:subagent-driven-development"' "$SESSION_FILE"; then
