...
TIMESTAMP=$(date +%s)
OUTPUT_DIR="/tmp/petropowers-tests/${TIMESTAMP}/explicit-skill-requests/claude-describes"
mkdir -p "$OUTPUT_DIR"

PROJECT_DIR="$OUTPUT_DIR/project"
mkdir -p "$PROJECT_DIR/docs/petropowers/plans"
...
# Create a plan
cat > "$PROJECT_DIR/docs/petropowers/plans/auth-system.md" << 'EOF'
...
claude -p "I have a plan at docs/petropowers/plans/auth-system.md. Tell me about my options for executing it, including what subagent-driven-development means and how it works." \
    --model haiku \
