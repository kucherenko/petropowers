...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/petropowers
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/petropowers-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using petropowers:subagent-driven-development. The plan is at: $PLAN_PATH"
