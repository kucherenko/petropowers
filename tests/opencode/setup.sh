...
#   $OPENCODE_CONFIG_DIR/petropowers/             ← package root
#   $OPENCODE_CONFIG_DIR/petropowers/skills/      ← skills dir (../../skills from plugin)
#   $OPENCODE_CONFIG_DIR/petropowers/.opencode/plugins/petropowers.js ← plugin file
#   $OPENCODE_CONFIG_DIR/plugins/petropowers.js   ← symlink OpenCode reads

SUPERPOWERS_DIR="$OPENCODE_CONFIG_DIR/petropowers"
SUPERPOWERS_SKILLS_DIR="$SUPERPOWERS_DIR/skills"
SUPERPOWERS_PLUGIN_FILE="$SUPERPOWERS_DIR/.opencode/plugins/petropowers.js"
...
cp "$REPO_ROOT/.opencode/plugins/petropowers.js" "$SUPERPOWERS_PLUGIN_FILE"

# Register plugin via symlink (what OpenCode actually reads)
mkdir -p "$OPENCODE_CONFIG_DIR/plugins"
ln -sf "$SUPERPOWERS_PLUGIN_FILE" "$OPENCODE_CONFIG_DIR/plugins/petropowers.js"
...
echo "Plugin registered at: $OPENCODE_CONFIG_DIR/plugins/petropowers.js"
