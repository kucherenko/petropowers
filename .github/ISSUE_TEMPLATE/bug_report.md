...
## Is this a PetroPowers issue or a platform issue?
<!-- PetroPowers is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without PetroPowers installed.

     If the problem persists without PetroPowers, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without PetroPowers installed
